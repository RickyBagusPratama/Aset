<div class="container">
    <div class="row-fluid">
        ...
        <div class="span12">
            <!-- Forms: Top Bar -->
            <div class="top-bar">
                <!--<h3><i class="icon-cog"></i>Aset tersedia</h3>-->
            </div>   
                    <div class="well padding">
                        ...
                        <blockquote style="padding:20px 10px 20px 10px; color:#333; margin:30px 30px 30px 30px;" >
                            <p>Monitoring daftar aset yang tersedia pada UPTB pemadam kebakaran</p>
                          </blockquote>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="font-weight: bold; font-size:14px; ">Jumlah</th>
                         </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        foreach ($tabel as $row):
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="align-center"><?php echo $row->jumlah; ?> </td>           
                            </tr>
                            <?php
                            $no++;
                        endforeach;
