    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <div class="well">
                ...
                <form name="myForm" action="<?php echo base_url();?>index.php/admin/edit_proses_barang/<?php echo $id; ?>"  method="post">  
                    <div class="control-group">
                        <label class="control-label">Kode Barang :</label>
                        <div class="controls">
                            <input type="text" class="span2 m-wrap" name="kodebarang" id="kodebarang" value="<?echo $row->kodebarang;?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span2 m-wrap" name="namabarang" id="namabarang" value="<?echo $row->namabarang;?>">
                            <span class="help-inline"></span>
                        </div>
                    </div>
