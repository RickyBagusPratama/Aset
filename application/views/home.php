...
<html lang="en">
    <head>
        ...
        <meta name="author" content="">
         <LINK REL="SHORTCUT ICON" HREF="<?php  echo base_url();?>assets/img/wow.jpg">
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="navbar-inner">
                ...
                <div class="container">
                    ...
                    <!-- / Logo / Brand Name -->
                    <a class="brand"><img src="<?php echo base_url(); ?>assets/img/wow.jpg" width="60" height="60"></a><a class="brand"><B><font style="font-size:24px; color:#CCC;">Pemdam Kebakaran</font><br>
                            Manajemen Aset Pemadam Kebakaran<br>
                            Kota Blitar
                        </B></a>
                    <!-- / Logo / Brand Name -->
        ...
        <div class="container" style="margin-top:100px;">  
               <form class="form-signin form-horizontal" action="<?php echo  base_url(); ?>index.php/home/log_in" method="post">
             <div class="top-bar">
                    <h3><i class="icon-leaf"></i>Damkar<b></b></h3>
                </div>
      ...
      <i class="icon icon-warning-sign"></i> <b>Maaf</b> ' . $this->session->userdata('message') . '</i></div>';
        ...
        <footer class="footer">
            ...
            <div class="container">
                ...
                <p>Copyrighted <a href="ptiik.ub.ac.id">Program Teknologi Informasi dan Ilmu Komputer</a> 2014. All rights resserved.</p>
                <p><a href="ub.ac.id">UNIVERSITAS BRAWIJAYA</a></p>
