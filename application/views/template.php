...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>UPTB PEMADAM KEBAKARAN</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="alert alert-light">
                ...
                <i class="icon-comment"></i> Selamat Datang Kembali, <b></b>
            </div>
            <!-- / Alert -->
...
-->    
<?php if(isset($error)){
    if ($error=="error") echo "<script type='text/javascript'> alert('Kode barang sudah ada');</script>";
    else if ($error=="pinjam") echo "<script type='text/javascript'> alert('Pegawai ini masih ada tanggungan');</script>";
}
