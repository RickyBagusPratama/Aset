...
if ($(".typeahead")[0]){
    ...
    $('.typeahead').typeahead({
        source: [ "TAWAR H", "CATUR Y V", "BUDIYANTO", "BAGUS S N", "YUDHA NH", "TEGUH SP", 
                  "ENDHIK S", "JUNI E.", "MESELAN", "Drs. DIDIK HARIADI MA. MS.i", "PR. PRABANDARI, SH", "RIBUT S", "MARATUS SHALIKAH  SH.", 
                  "HARYONO SE.", "LILIK H", "SUPRIYADI", "SUPRAPTO", "HADI WIYANTO", "AGUS ARIFIN", "SONY", "EKO Y", 
                  "MARYONO", "WISNU MPW", "PUJI WIBOWO", "SUBUR", "Selang 1.5 dim", "Selang 3 dim", "Motor", 
                  "Pompa Angin", "Mobil PMK", "Changer ACCU", "Rabbit", "Dongkrak", "Handy Talky", "Pesawat Rig", "Baju tahan api", 
                  "Sepatu", "Helm", "Sarung Tangan", "Masker", "Kapak", "Tangga Alumunium", "APAR", "Senter Kedip", 
                  "Kapak Kunci Hydrand", "Sekop", "Gantol stenlish", "Rompi anti panas", "Sepatu tahan api", "Slang" 
                  ]
        }
    );
